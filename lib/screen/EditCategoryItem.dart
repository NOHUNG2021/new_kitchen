...
class _EditCategoryItemScreenState extends State<EditCategoryItemScreen> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        imageURL != AppConstant.noImageUrl ? InkWell(
                          onTap: (() => {
                            emptyImage()
                          }),
                          child: Container(
  ...
  Future<EditCategoryItem> ediCategoryItem(
    ...
    print(
        "kitchen_id $userId  ${widget.categoryId} ,   ${_image != null ? true : false},    ${widget.categoryItemId},");
    progressDialog.show();
    ...
    try {
      ...
      EditCategoryItem bean = await ApiProvider().editCategoryItem(data);
      print(bean.data);
  ...
  Future<GetCategoryItemDetails> getCategoryItemDetail(
    ...
    try {
      ...
      GetCategoryItemDetails bean =
          await ApiProvider().getCategoryItemDetail(from);
      progressDialog.dismiss();
      if (bean.status == true) {
        setState(() {
         ...
         // _image = File(bean.data.image);
          //print(_image.path + " JJ");
          imageURL =
              bean.data.image == '' ? AppConstant.noImageUrl : bean.data.image;
          // _image = File(bean.data.image);
